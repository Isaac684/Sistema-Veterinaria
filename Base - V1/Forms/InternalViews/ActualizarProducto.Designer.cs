namespace Base___V1.Forms.InternalViews
{
	partial class ActualizarProducto
	{
		...
		private void InitializeComponent()
		{
			...
			button2.Location = new Point(397, 3);
			...
			tableLayoutPanel2.Size = new Size(767, 42);
			...
			tableLayoutPanel1.Size = new Size(773, 458);
			...
			tableLayoutPanel3.Size = new Size(767, 268);
			tableLayoutPanel3.TabIndex = 15;
			// 
			// txt7
			// 
			txt7.Anchor = AnchorStyles.Left | AnchorStyles.Right;
			txt7.Location = new Point(518, 209);
			txt7.Name = "txt7";
			txt7.Size = new Size(246, 27);
			txt7.TabIndex = 28;
			// 
			// label2
			// 
			...
			label3.Location = new Point(386, 0);
			label3.Name = "label3";
			label3.Size = new Size(126, 89);
			label3.TabIndex = 15;
			...
			label7.Location = new Point(386, 89);
			label7.Name = "label7";
			label7.Size = new Size(126, 89);
			label7.TabIndex = 22;
			...
			label6.Location = new Point(386, 178);
			label6.Name = "label6";
			label6.Size = new Size(126, 90);
			label6.TabIndex = 20;
			...
			txt1.Location = new Point(129, 31);
			txt1.Name = "txt1";
			txt1.Size = new Size(251, 27);
			txt1.TabIndex = 23;
			// 
			// txt2
			// 
			txt2.Anchor = AnchorStyles.Left | AnchorStyles.Right;
			txt2.Location = new Point(129, 120);
			txt2.Name = "txt2";
			txt2.Size = new Size(251, 27);
			txt2.TabIndex = 24;
			// 
			// txt6
			// 
			txt6.Anchor = AnchorStyles.Left | AnchorStyles.Right;
			txt6.Location = new Point(129, 209);
			txt6.Name = "txt6";
			txt6.Size = new Size(251, 27);
			txt6.TabIndex = 25;
			// 
			// txt4
			// 
			txt4.Anchor = AnchorStyles.Left | AnchorStyles.Right;
			txt4.Location = new Point(518, 31);
			txt4.Name = "txt4";
			txt4.Size = new Size(246, 27);
			txt4.TabIndex = 26;
			// 
			// txt5
			// 
			txt5.Anchor = AnchorStyles.Left | AnchorStyles.Right;
			txt5.Location = new Point(518, 120);
			txt5.Name = "txt5";
			txt5.Size = new Size(246, 27);
			txt5.TabIndex = 27;
			// 
			// tableLayoutPanel4
			// 
			...
			tableLayoutPanel4.Size = new Size(767, 42);
			...
			txt3.Location = new Point(150, 7);
			txt3.Name = "txt3";
			txt3.Size = new Size(614, 27);
			txt3.TabIndex = 22;
			// 
			// ActualizarProducto
			// 

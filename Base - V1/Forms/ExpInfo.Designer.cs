namespace Base___V1
{
	partial class ExpInfo
	{
		...
		private void InitializeComponent()
		{
			...
			ExpInfoPanel.Controls.Add(cbxCamara);
			ExpInfoPanel.Controls.Add(pb1);
			...
			ExpInfoPanel.Size = new Size(882, 911);
			...
			label12.Location = new Point(559, 644);
			...
			// btnCapturar
			// 
			btnCapturar.Anchor = AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right;
			...
			btnCapturar.Location = new Point(228, 848);
			btnCapturar.Name = "btnCapturar";
			btnCapturar.Size = new Size(117, 30);
			...
			pb2.Location = new Point(559, 678);
			pb2.Name = "pb2";
			pb2.Size = new Size(311, 200);
			...
			cbxCamara.Location = new Point(90, 644);
			cbxCamara.Name = "cbxCamara";
			cbxCamara.Size = new Size(255, 28);
			...
			pb1.Location = new Point(34, 678);
			pb1.Name = "pb1";
			pb1.Size = new Size(310, 200);
			pb1.TabIndex = 70;
			pb1.TabStop = false;
			// 
			// label9
			...
			label9.Location = new Point(34, 644);
			label9.Name = "label9";
			...
			pbFoto.Location = new Point(307, 12);
			pbFoto.Name = "pbFoto";
			pbFoto.Size = new Size(260, 161);
			...
			cbEdicion.Location = new Point(703, 632);
			...
			// txtSeñas
			// 
			txtSeñas.Location = new Point(665, 303);
			...
			txtEdad.Location = new Point(665, 235);
			...
			lblNombrePaciente.Location = new Point(270, 176);
			...
			label13.Location = new Point(590, 578);
			...
			txtTelefono.Location = new Point(686, 575);
			...
			label14.Location = new Point(31, 578);
			...
			txtCorreo.Location = new Point(149, 575);
			...
			label11.Location = new Point(31, 503);
			...
			txtDireccion.Location = new Point(149, 500);
			...
			txtNombrePro.Location = new Point(149, 446);
			...
			label8.Location = new Point(590, 303);
			label8.Name = "label8";
			...
			cbSexo.Location = new Point(131, 306);
			cbSexo.Name = "cbSexo";
			...
			label5.Location = new Point(318, 309);
			label5.Name = "label5";
			...
			// txtColor
			// 
			txtColor.Location = new Point(387, 305);
			...
			label7.Location = new Point(597, 235);
			label7.Name = "label7";
			...
			label4.Location = new Point(318, 238);
			label4.Name = "label4";
			...
			txtRaza.Location = new Point(385, 235);
			...
			txtEspecie.Location = new Point(131, 235);
			...
			lblDatosPaciente.Location = new Point(35, 176);
			...
			lblDatosPropietario.Location = new Point(31, 361);
			...
			btnCancel.Location = new Point(561, 846);
